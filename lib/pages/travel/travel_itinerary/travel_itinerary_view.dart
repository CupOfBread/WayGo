  ...
  Widget _buildPlace(Map<String, dynamic> item) {
    return Card(
      ...
      child: ListTile(
        ...
        trailing: item['image'] != null ? Image.network(item['image'], width: 48, height: 48, fit: BoxFit.cover) : null,
      ),
    );
  }
