...
class ScenicSpotDetailLogic extends GetxController {
  ...
  void onInit() {
    ...
    state.spot.value = ScenicSpot(
      ...
      description: '人民公园位于成都市中心，是成都市最具代表性的城市公园之一。园内环境优美，绿树成荫，湖泊与花卉相映成趣，是市民休闲、散步、品茶的好去处。',
      extInfo: ScenicSpotExtInfo(
        scenicSpotId: 1,
        businessHours: '06:00-22:00',
        location: '四川省成都市青羊区少城路12号',
